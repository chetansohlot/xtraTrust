"""
Django settings for xtraTrustInsurance project.
...
ROOT_URLCONF = 'xtraTrustInsurance.urls'
...
WSGI_APPLICATION = 'xtraTrustInsurance.wsgi.application'
...
XTRATRUST_SIGNATURE_WITH_EMP_PORTAL = os.getenv('XTRATRUST_SIGNATURE_WITH_EMP_PORTAL', 'empPortal/static/dist/img/elevate-signature.png')
...
COMPANY_CFT = os.getenv('COMPANY_CFT', 'XTRAIN')
COMPANY_EMP = os.getenv('COMPANY_EMP', 'XTRA')
SIGNATURE_XTRATRUST = os.getenv('SIGNATURE_XTRATRUST', 'empPortal/static/dist/img/elevate-signature.png')
